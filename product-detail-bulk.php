  ...
  <div class="middle_main_new">
    ...
    <div class="left_dress">
      ...
      <div class="right_dress">
        ...
        <div class="meshmire_rs">
          <div class="main_price2"><span class="green">Retail Price</span></div>
...
?u=http://picklesanimation.com/honey2/product-detail.php?pid=<?php echo $fetch['p_id'];?>" target="_blank"><img src="images/fb.jpg" /></a></div>
    ...
    <form name="newsize" action="view-cart-bulk.php" method="post" enctype="multipart/form-data" onsubmit="return checkQuantity();">
      ...
      <div class="main_editor3">
        ...
        <?php
		 ...
		 <?php
			...
			$query_img_mid=mysqli_query($conn,$select_img_mid);
			while($fetch_img_mid=mysqli_fetch_array($query_img_mid)){
		?>
...
<!--<div class="txt_adj">this is testing</div>
-->          <div class="sizeguide">Quantity:</div>
          <div class="quantity_size">
