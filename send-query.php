...
<!--<div class="whitespacehome"></div>
 --><div class="mission_top">
  ...
  <div class="mn_fm_r">
<div class="mn_fm1_r"></div>
<div class="mn_fm2_r">
<form name="enquery" action="thanks-query.php" method="post">
<div class="mn_fm_top_r">Query Form</div>
<div class="sbm_fm_r1">
<div class="mn_fm3_r">
...
<div class="name_fm_r">Message</div>
...
<div class="sbmt_fm_rr">
  <input type="submit" class="sbmt_fm_rr_box" name="send" id="send" value="Send Qurey" />
</div>
</form>
</div>
</div>
