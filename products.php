...
$(document).ready(function() {
	...
	$('#results').load("autoload_process.php", {'group_no':track_load,'cid':cid,'scid':scid,'sscid':sscid,'price':price}, function() {track_load++;});
	$(window).scroll(function() {
		if($(window).scrollTop() + $(window).height() == $(document).height())
		{
			if(track_load <= total_groups && loading==false) 
			{
				...
				$.post('autoload_process.php',{'group_no': track_load,'cid':cid,'scid':scid,'sscid':sscid,'price':price}, function(data){				
					$("#results").append(data); 
