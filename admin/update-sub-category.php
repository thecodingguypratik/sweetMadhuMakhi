<?php
	...
	$select="select * from subcategories where id='".$_REQUEST['id']."'";
	...
	if(isset($_POST['submit'])){
		...
		if($error==""){
			$update="update subcategories set parent_id='".$parent_id."',name='".$name."',title='".$title."',keyword='".$keyword."',status='".$status."' where id='".$_REQUEST['id']."'";
			...
			if($query>0){
				...
				$error="Sub Category Not Updated";
			}
		}
	}
?>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                              	<select name="parent_id" id="parent_id">
                                    ...
                                    ?>
                                    <option value="<?php echo $all_pro['id'];?>" <?php echo ($all_pro['id']==$fetch_main['parent_id']?'selected':'');?>><?php echo $all_pro['name'];?></option>
                                  <?php  }?>
                                </select>
                               </div>
                            </div>
