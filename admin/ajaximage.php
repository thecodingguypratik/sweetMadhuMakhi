<?php
	...
	$upload_dir = 'banner/'; // Directory for file storing
	$preview_url = 'http://localhost/onlineshop/admin/banner/';
	$filename= '';
	$result = 'ERROR';
	$result_msg = '';
	...
	if($filename != '') {
	echo "parDoc.getElementById('picture_preview').innerHTML = '<img src=\'$preview_url$filename\' id=\'preview_picture_tag\' height=\'200\' width=\'650\' name=\'preview_picture_tag\' />';";
	}
	echo "\n".'</script>';
