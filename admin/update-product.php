<?php
	...
	$select_show="select * from product where p_id='".$_REQUEST['id']."'";
	$query_show=mysqli_query($conn,$select_show);
	$fetch=mysqli_fetch_array($query_show);
	$sizeexp=explode(',',$fetch['size']);
	...
	if(isset($_POST['submit'])){
		...
		if($error==""){
			...
			if($_FILES['image4']['name']!=""){
				...
				$filename4=$fetch['image4'];
			}
			//insert general information
			$update="update product set name='".mysqli_real_escape_string($conn,$name)."',product_code='".mysqli_real_escape_string($conn,$product_code)."',description='".mysqli_real_escape_string($conn,$description)."',short_description='".mysqli_real_escape_string($conn,$short_description)."',delivery='".mysqli_real_escape_string($conn,$delivery)."',status='".mysqli_real_escape_string($conn,$status)."',country_manufacture='".mysqli_real_escape_string($conn,$country_manufacture )."',price='".mysqli_real_escape_string($conn,$price)."',bulk_price='".mysqli_real_escape_string($conn,$bulk_price)."',title='".mysqli_real_escape_string($conn,$title)."',meta_keywords='".mysqli_real_escape_string($conn,$meta_keywords)."',meta_description='".mysqli_real_escape_string($conn,$meta_description)."',image1='".mysqli_real_escape_string($conn,$filename1)."',image2='".mysqli_real_escape_string($conn,$filename2)."',image3='".mysqli_real_escape_string($conn,$filename3)."',image4='".mysqli_real_escape_string($conn,$filename4)."',qty='".mysqli_real_escape_string($conn,$qty)."',min_qty_allow='".mysqli_real_escape_string($conn,$min_qty_allow)."',max_qty_allow='".mysqli_real_escape_string($conn,$max_qty_allow)."',stock_availability='".mysqli_real_escape_string($conn,$stock_availability)."',sizetype='".mysqli_real_escape_string($conn,$_POST['sizetype'])."',size='".mysqli_real_escape_string($conn,$size)."',color='".mysqli_real_escape_string($conn,$color)."',cat_id='".mysqli_real_escape_string($conn,$cat_id)."',sub_cat_id='".mysqli_real_escape_string($conn,$sub_cat_id)."',sub_sub_cat_id='".mysqli_real_escape_string($conn,$sub_sub_cat_id)."',cshow='".mysqli_real_escape_string($conn,$show)."' where p_id='".mysqli_real_escape_string($conn,$_REQUEST['id'])."'";
            ...
            <div class="row-fluid section">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">Update Product</div>
                    </div>
                                    ...
                                    <div class="tab-pane" id="tab1">
                                          <fieldset>
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <input class="input-xlarge focused" name="name" id="name" type="text" value="<?php echo $fetch['name'];?>">
                                              </div>
                                            </div>
                                            <div class="control-group">
                                              <label class="control-label" for="focusedInput">Product Code</label>
                                              <div class="controls">
                                                <input class="input-xlarge focused" name="product_code" id="product_code" type="text" value="<?php echo $fetch['product_code'];?>">
                                              </div>
                                            </div>
                                            <div class="control-group">
                                              <label class="control-label" for="focusedInput">Description</label>
                                              <div class="controls">
                                                <textarea name="description" id="description" rows="5" cols="36" class="input-xlarge focused"><?php echo $fetch['description'];?></textarea>
                                              </div>
                                            </div>
                                            <div class="control-group">
                                              <label class="control-label" for="focusedInput">Short Description</label>
                                              <div class="controls">
                                                <textarea name="short_description" id="short_description" rows="5" cols="36" class="input-xlarge focused"><?php echo $fetch['short_description'];?></textarea>
                                              </div>
                                            </div>
											 ...
											 <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <textarea name="delivery" id="deliver" rows="5" cols="36" class="input-xlarge focused"><?php echo $fetch['delivery'];?></textarea>
                                              </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <input type="text" name="country_manufacture" id="country_manufacture" class="input-xlarge focused" value="<?php echo $fetch['country_manufacture'];?>"/>
                                              </div>
                                            </div>
                                            <div class="control-group">
                                    ...
                                    <div class="tab-pane" id="tab2">
                                          <fieldset>
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <input type="text" name="price" id="price" class="input-xlarge focused" value="<?php echo $fetch['price'];?>"/>
                                              </div>
                                            </div>
                                            <!--<div class="control-group">
                                              <label class="control-label" for="focusedInput">Display Actual Price</label>
                                              <div class="controls">
                                                <input type="text" name="actual_price" id="actual_price" class="input-xlarge focused" value="<?php echo $fetch['actual_price'];?>"/>
                                              </div>
                                            </div>-->
                                             <div class="control-group">
                                              <label class="control-label" for="focusedInput">Display Bulk Price</label>
                                              <div class="controls">
                                                <input type="text" name="bulk_price" id="bulk_price" class="input-xlarge focused" value="<?php echo $fetch['bulk_price'];?>"/>
                                              </div>
                                            </div>
                                          </fieldset>
                                    </div>
                                    <div class="tab-pane" id="tab3">
                                          <fieldset>
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <input type="text" name="title" id="title" class="input-xlarge focused" value="<?php echo $fetch['title'];?>"/>
                                              </div>
                                            </div>
                                            <div class="control-group">
                                              <label class="control-label" for="focusedInput">Meta Keywords</label>
                                              <div class="controls">
                                                <textarea name="meta_keywords" id="meta_keywords" rows="5" cols="36" class="input-xlarge focused"><?php echo $fetch['meta_keywords'];?></textarea>
                                              </div>
                                            </div>
                                            <div class="control-group">
                                              <label class="control-label" for="focusedInput">Meta Description</label>
                                              <div class="controls">
                                                <textarea name="meta_description" id="meta_description" rows="5" cols="36" class="input-xlarge focused"><?php echo $fetch['meta_description'];?></textarea>
                                              </div>
                                            </div>
                                          </fieldset>
                                    </div>
                                    <div class="tab-pane" id="tab4">
                                          <fieldset>
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <input type="file" name="image1" id="image1" size="54" /><img src="product_images/<?php echo $fetch['image1'];?>" width="50" height="50" alt=""/>
                                              </div>
                                            </div>
                                            <div class="control-group">
                                              <label class="control-label" for="focusedInput">Image 2</label>
                                              <div class="controls">
                                                <input type="file" name="image2" id="image2" size="54" /><img src="product_images/<?php echo $fetch['image2'];?>" width="50" height="50" alt=""/>
                                              </div>
                                            </div>
                                            <div class="control-group">
                                              <label class="control-label" for="focusedInput">Image 3</label>
                                              <div class="controls">
                                                <input type="file" name="image3" id="image3" size="54" /><img src="product_images/<?php echo $fetch['image3'];?>" width="50" height="50" alt=""/>
                                              </div>
                                            </div>
                                            <div class="control-group">
                                              <label class="control-label" for="focusedInput">Image 4</label>
                                              <div class="controls">
                                                <input type="file" name="image4" id="image4" size="54" /><img src="product_images/<?php echo $fetch['image4'];?>" width="50" height="50" alt=""/>
                                              </div>
                                            </div>
                                          </fieldset>
                                    </div>
                                    <div class="tab-pane" id="tab5">
                                          <fieldset>
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <input class="input-xlarge focused" name="qty" id="qty" type="text" value="<?php echo $fetch['qty'];?>">
                                              </div>
                                            </div>
                                            <div class="control-group">
                                              <label class="control-label" for="focusedInput">Minimum Qty Allowed in Shopping Cart</label>
                                              <div class="controls">
                                                <input class="input-xlarge focused" name="min_qty_allow" id="min_qty_allow" type="text" value="<?php echo $fetch['min_qty_allow'];?>">
                                              </div>
                                            </div>
                                            <div class="control-group">
                                              <label class="control-label" for="focusedInput">Maximum Qty Allowed in Shopping Cart</label>
                                              <div class="controls">
                                                <input class="input-xlarge focused" name="max_qty_allow" id="max_qty_allow" type="text" value="<?php echo $fetch['max_qty_allow'];?>">
                                              </div>
                                            </div>
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <select name="stock_availability" id="stock_availability" class="input-xlarge focused">
                                                    <option value="">Select Status</option>
                                                    <option value="In Stock" <?php echo ($fetch['stock_availability']=="In Stock"?'selected':'');?>>In Stock</option>
                                                    <option value="Out Of Stock" <?php echo ($fetch['stock_availability']=="Out Of Stock"?'selected':'');?>>Out Of Stock</option>
                                                </select>
                                              </div>
                                            </div>
                                            <!--<div class="control-group">
                                              ...
                                              <div class="controls">
											    <input type="radio" name="sizetype" id="sizetype" value="cloth" <?php echo($fetch['sizetype']=='cloth'?'checked':'');?>>
                                                S <input name="size[]" type="checkbox" value="S" <?php for($i=0;$i<count($sizeexp);$i++){ echo ($sizeexp[$i]=='S'?'checked':'');}?>> 
                                                M <input name="size[]" type="checkbox" value="M" <?php for($i=0;$i<count($sizeexp);$i++){ echo ($sizeexp[$i]=='M'?'checked':'');}?>> 
                                                L <input name="size[]" type="checkbox" value="L" <?php for($i=0;$i<count($sizeexp);$i++){ echo ($sizeexp[$i]=='L'?'checked':'');}?>><br>
												<input type="radio" name="sizetype" id="sizetype" value="shoes" <?php echo($fetch['sizetype']=='shoes'?'checked':'');?>>
                                                6 <input name="sizess[]"  type="checkbox" value="6" <?php for($i=0;$i<count($sizeexp);$i++){ echo ($sizeexp[$i]=='6'?'checked':'');}?>> 
                                                7 <input name="sizess[]"  type="checkbox" value="7" <?php for($i=0;$i<count($sizeexp);$i++){ echo ($sizeexp[$i]=='7'?'checked':'');}?>> 
                                                8 <input name="sizess[]"  type="checkbox" value="8" <?php for($i=0;$i<count($sizeexp);$i++){ echo ($sizeexp[$i]=='8'?'checked':'');}?>>
												9 <input name="sizess[]"  type="checkbox" value="9" <?php for($i=0;$i<count($sizeexp);$i++){ echo ($sizeexp[$i]=='9'?'checked':'');}?>>
												10 <input name="sizess[]"  type="checkbox" value="10" <?php for($i=0;$i<count($sizeexp);$i++){ echo ($sizeexp[$i]=='10'?'checked':'');}?>>
												11 <input name="sizess[]"  type="checkbox" value="11" <?php for($i=0;$i<count($sizeexp);$i++){ echo ($sizeexp[$i]=='11'?'checked':'');}?>><br>
												<input type="radio" name="sizetype" id="sizetype" value="none" <?php echo($fetch['sizetype']=='none'?'checked':'');?>>
												None
                                              </div>
                                            </div>-->
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <select name="color" id="color" class="input-xlarge focused">
                                                    ...
                                                    <option value="White" <?php echo ($fetch['color']=="White"?'selected':'');?>>White</option>
                                                    <option value="Green" <?php echo ($fetch['color']=="Green"?'selected':'');?>>Green</option>
                                                    <option value="Blue" <?php echo ($fetch['color']=="Blue"?'selected':'');?>>Blue</option>
                                                    <option value="Red" <?php echo ($fetch['color']=="Red"?'selected':'');?>>Red</option>
                                                    <option value="Yellow" <?php echo ($fetch['color']=="Yellow"?'selected':'');?>>Yellow</option>
                                                    <option value="Pink" <?php echo ($fetch['color']=="Pink"?'selected':'');?>>Pink</option>
                                                    <option value="Black" <?php echo ($fetch['color']=="Black"?'selected':'');?>>Black</option>
                                                    <option value="Gray" <?php echo ($fetch['color']=="Gray"?'selected':'');?>>Gray</option>
                                                </select>
                                              </div>
                                            </div>
                                          </fieldset>
                                           ...
                                           <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <select name="cat_id" id="cat_id" class="input-xlarge focused">
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $all_pro['id'];?>" <?php echo ($fetch['cat_id']==$all_pro['id']?'selected':'');?>><?php echo $all_pro['name'];?></option>
                                                  <?php  }?>
                                                </select>
                                              </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <select name="sub_sub_cat_id" id="sub_sub_cat_id" class="input-xlarge focused">
                                                    <option value="" selected>Select Sub Sub Category Name</option>
                                                </select>
                                              </div>
                                            </div>
											<div class="control-group">
                                              ...
                                              <div class="controls">
                                               <input type="radio" name="show" id="show" value="1" <?php echo ($fetch['cshow']=='1'?'checked':'');?> />Active
											   <input type="radio" name="show" id="show" value="2" <?php echo ($fetch['cshow']=='2'?'checked':'');?> />Browse
											   <input type="radio" name="show" id="show" value="3" <?php echo ($fetch['cshow']=='3'?'checked':'');?> />None
                                              </div>
                                            </div>
                                          </fieldset>
                                    </div>
