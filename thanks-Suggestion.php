<?php 
	...
	if(isset($_POST['submit']))
	{
		...
		$message=$_POST['message'];
			...
			$message_user="Honey bees Suggestions";
...
<div class="wrk_one_r">
<div class="wrk_two_r">feedback & suggestions</div>
<div class="wrk_three_r_thanks">Thanks for your feedback & suggestions ! We will considered it on priority basis</div>
