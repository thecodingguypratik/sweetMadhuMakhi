...
<style>
.showblock {
margin-top: -241px; top: 50%; display: block; height: 482px; right: -2px;
}
.hideBlock {
margin-top: -241px; top: 50%; display: block; height: 482px; right: -462px;
}
</style>
                    ...
                    req.onreadystatechange = function() {
                        if (req.readyState == 4) {
                            if (req.status == 200) {				
                                ...
                                document.querySelector("#mrova-feedback").style.right = "-462px";					
                            }
                        }				
                    }			
...
<div class="header">
  ...
  <div class="hd_main_one_big">
	...
	if ($_SESSION['rid']!= "") {
	?>
    <div class="clientname">Hello - <?php echo $_SESSION['name'];?></div>
	<?php
	}
	?>
    <div class="hd_main_two_big" style="margin-bottom:5px;">
    ...
    <div class="hd_main_two_big2" style="width:500px; margin-right:10px;">
<div class="hd_cart_one_main">
<!--<div class="sign_withragister1">-->
<div class="tp_home_r"><a href="http://www.honeybeesgift.com">Home</a></div>
   <div class="main_line"></div>
        ...
        <div class="sign_withragister"><a href="javascript:void(0)" onClick="document.getElementById('lights_cor').style.display='block';document.getElementById('fades_cor').style.display = 'block'">REGISTER</a></div>
                        ...
                        ?>
        <div class="sign_withragister1"><a href="my-wishlist.php">My Wishlist</a></div>
        <div class="main_line"></div>
        <div class="sign_withragister1"><a href="order-status.php">My Account</a></div>
        <div class="main_line"></div>
        <div class="sign_withragister1"><a href="logout.php">Logout</a></div>
        <?php
                         }
                        ?>
        ...
        <div style="width: 400px; padding: 0px 0 0px;">
          ...
          <div class="f_log_main">
            ...
            <div class="box_one">
              ...
              <div class="f_log_mid">
              <div class="email_one">Name</div>
                <div class="email_fom">
                  <input name="name" type="text" class="email_fom_box" id="name" />
                  </div>
                <div class="email_one" style="margin-top:20px">Email</div>
                <div class="email_fom">
