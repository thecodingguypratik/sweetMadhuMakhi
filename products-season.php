...
$(document).ready(function() {
	...
	$('#results').load("autoload_process_season.php", {'group_no':track_load,'price':price,'cid':cid}, function() {track_load++;});
	$(window).scroll(function() {
		if($(window).scrollTop() + $(window).height() == $(document).height())
		{
			if(track_load <= total_groups && loading==false) 
			{
				...
				$.post('autoload_process_season.php',{'group_no': track_load,'price':price,'cid':cid}, function(data){				
					$("#results").append(data); 
