<?php
	...
	$select="select p_id,product_code,image1,name,short_description,price,bulk_price FROM product WHERE cat_id='".$_REQUEST['cid']."' and sub_cat_id='".$_REQUEST['scid']."' ";
	if($min!="" && $max!=""){
...
$(document).ready(function() {
	...
	$('#results').load("autoload_process_level.php", {'group_no':track_load,'cid':cid,'scid':scid,'price':price}, function() {track_load++;});
	$(window).scroll(function() {
		if($(window).scrollTop() + $(window).height() == $(document).height())
		{
			if(track_load <= total_groups && loading==false) 
			{
				...
				$.post('autoload_process_level.php',{'group_no': track_load,'cid':cid,'scid':scid,'price':price}, function(data){				
					$("#results").append(data); 
      ...
      <div class="nursery_left">
        ...
        <div class="price_nursery">
          ...
          <div class="pricelist_rad">
              <div class="rad_plist">
                <input name="pricerange" type="radio" value="0-10000"  class="nurese_radiobu" onclick="findproduct(this.value);"/>
              </div>
              <div class="plist_right">See All</div>
            </div>
            <div class="pricelist_rad">
              <div class="rad_plist">
